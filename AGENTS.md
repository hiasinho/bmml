...
test/
  fixtures/     # example .bmml files (valid and invalid)
specs/
...
- Test fixtures in `test/fixtures/*.bmml` show valid/invalid examples
- `valid-*.bmml` should pass validation
- `invalid-*.bmml` should fail with specific errors
