...
import type { SchemaVersion } from './validator.js';
...
/**
 * Lint a BMML document for reference integrity issues.
 * Only v2 documents are supported.
 */
export function lint(doc: BMCDocumentV2): LintResult {
  return lintV2(doc);
}
...
/**
 * Lint a BMML document and return true if no errors were found
 */
export function lintIsValid(doc: BMCDocumentV2): boolean {
